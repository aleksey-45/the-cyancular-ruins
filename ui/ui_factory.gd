...
const C_SLOT_EMPTY  := Color(0.510, 0.600, 0.624)   # 未占据:淡灰,比底板亮一档 → 看得见但后退 #82999F
const C_SLOT_FILLED := Color(0.310, 0.702, 0.702)   # 已占据:淡青 #4FB3B3
const C_SLOT_ACTIVE := Color(0.071, 0.286, 0.306)   # 手持那把占的格:深青,离底板最远 → 最跳 #12494E
